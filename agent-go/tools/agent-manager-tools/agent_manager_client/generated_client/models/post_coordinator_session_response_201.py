...
T = TypeVar("T", bound="PostCoordinatorSessionResponse201")


@_attrs_define
class PostCoordinatorSessionResponse201:
    """
    Attributes:
        id (str):
        title (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_coordinator_session_response_201 = cls(
            id=id,
            title=title,
        ...
        post_coordinator_session_response_201.additional_properties = d
        return post_coordinator_session_response_201
