...
T = TypeVar("T", bound="PostApiKeysIdRevokeResponse200ApiKey")


@_attrs_define
class PostApiKeysIdRevokeResponse200ApiKey:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_keys_id_revoke_response_200_api_key = cls(
            id=id,
            name=name,
        ...
        post_api_keys_id_revoke_response_200_api_key.additional_properties = d
        return post_api_keys_id_revoke_response_200_api_key
