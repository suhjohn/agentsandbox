...
if TYPE_CHECKING:
    from ..models.patch_users_me_response_200_workspace_keybindings_type_0 import (
        PatchUsersMeResponse200WorkspaceKeybindingsType0,
    )


T = TypeVar("T", bound="PatchUsersMeResponse200")


@_attrs_define
class PatchUsersMeResponse200:
    """
    Attributes:
        id (str):
        email (str):
        ...
        workspace_keybindings (None | PatchUsersMeResponse200WorkspaceKeybindingsType0):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.workspace_keybindings, PatchUsersMeResponse200WorkspaceKeybindingsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_workspace_keybindings(
            data: object,
        ) -> None | PatchUsersMeResponse200WorkspaceKeybindingsType0:
            if data is None:
                return data
            try:
                ...
                workspace_keybindings_type_0 = (
                    PatchUsersMeResponse200WorkspaceKeybindingsType0.from_dict(data)
                )

                return workspace_keybindings_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PatchUsersMeResponse200WorkspaceKeybindingsType0, data)

        workspace_keybindings = _parse_workspace_keybindings(
            d.pop("workspaceKeybindings")
        )

        patch_users_me_response_200 = cls(
            id=id,
            email=email,
            name=name,
            avatar=avatar,
        ...
        patch_users_me_response_200.additional_properties = d
        return patch_users_me_response_200
