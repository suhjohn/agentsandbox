...
T = TypeVar("T", bound="GetAgentsAgentIdAccessResponse200")


@_attrs_define
class GetAgentsAgentIdAccessResponse200:
    """
    Attributes:
        open_vscode_url (str):
        no_vnc_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_agents_agent_id_access_response_200 = cls(
        ...
        get_agents_agent_id_access_response_200.additional_properties = d
        return get_agents_agent_id_access_response_200
