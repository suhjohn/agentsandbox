...
if TYPE_CHECKING:
    from ..models.put_users_me_avatar_response_200_workspace_keybindings_type_0 import (
        PutUsersMeAvatarResponse200WorkspaceKeybindingsType0,
    )


T = TypeVar("T", bound="PutUsersMeAvatarResponse200")


@_attrs_define
class PutUsersMeAvatarResponse200:
    """
    Attributes:
        id (str):
        email (str):
        ...
        workspace_keybindings (None | PutUsersMeAvatarResponse200WorkspaceKeybindingsType0):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_workspace_keybindings(
            data: object,
        ) -> None | PutUsersMeAvatarResponse200WorkspaceKeybindingsType0:
            if data is None:
                return data
            try:
                ...
                workspace_keybindings_type_0 = (
                    PutUsersMeAvatarResponse200WorkspaceKeybindingsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PutUsersMeAvatarResponse200WorkspaceKeybindingsType0, data
            )
        ...
        put_users_me_avatar_response_200 = cls(
            id=id,
            email=email,
            name=name,
            avatar=avatar,
        ...
        put_users_me_avatar_response_200.additional_properties = d
        return put_users_me_avatar_response_200
