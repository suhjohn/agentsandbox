...
T = TypeVar("T", bound="GetSessionResponse200DataItem")


@_attrs_define
class GetSessionResponse200DataItem:
    """
    Attributes:
        id (str):
        agent_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_session_response_200_data_item = cls(
            id=id,
            agent_id=agent_id,
            image_id=image_id,
        ...
        get_session_response_200_data_item.additional_properties = d
        return get_session_response_200_data_item
