...
T = TypeVar("T", bound="GetSessionGroupsResponse200DataItemSessionsItem")


@_attrs_define
class GetSessionGroupsResponse200DataItemSessionsItem:
    """
    Attributes:
        id (str):
        agent_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_session_groups_response_200_data_item_sessions_item = cls(
            id=id,
            agent_id=agent_id,
            image_id=image_id,
        ...
        get_session_groups_response_200_data_item_sessions_item.additional_properties = d
        return get_session_groups_response_200_data_item_sessions_item
