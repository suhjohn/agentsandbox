...
from ..models.get_agents_response_200_data_item_status import (
    GetAgentsResponse200DataItemStatus,
)
from ..models.get_agents_response_200_data_item_type import (
    GetAgentsResponse200DataItemType,
)
from ..models.get_agents_response_200_data_item_visibility import (
    GetAgentsResponse200DataItemVisibility,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_agents_response_200_data_item_created_by_user_type_0 import (
        GetAgentsResponse200DataItemCreatedByUserType0,
    )
    from ..models.get_agents_response_200_data_item_image_type_0 import (
        GetAgentsResponse200DataItemImageType0,
    )
    from ..models.get_agents_response_200_data_item_sub_agents_item import (
        GetAgentsResponse200DataItemSubAgentsItem,
    )


T = TypeVar("T", bound="GetAgentsResponse200DataItem")


@_attrs_define
class GetAgentsResponse200DataItem:
    """
    Attributes:
        id (str):
        name (str):
        type_ (GetAgentsResponse200DataItemType):
        visibility (GetAgentsResponse200DataItemVisibility):
        status (GetAgentsResponse200DataItemStatus):
        created_by (None | str):
        created_by_user (GetAgentsResponse200DataItemCreatedByUserType0 | None):
        ...
        image (GetAgentsResponse200DataItemImageType0 | None | Unset):
        current_sandbox_id (None | str | Unset):
        sandbox_name (None | str | Unset):
        snapshot_image_id (None | str | Unset):
        region (None | str | Unset):
        sub_agents (list[GetAgentsResponse200DataItemSubAgentsItem] | Unset):
    """
    ...
    image: GetAgentsResponse200DataItemImageType0 | None | Unset = UNSET
    current_sandbox_id: None | str | Unset = UNSET
    sandbox_name: None | str | Unset = UNSET
    snapshot_image_id: None | str | Unset = UNSET
    region: None | str | Unset = UNSET
    sub_agents: list[GetAgentsResponse200DataItemSubAgentsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.created_by_user, GetAgentsResponse200DataItemCreatedByUserType0
        ):
        ...
        if isinstance(self.image, Unset):
            image = UNSET
        elif isinstance(self.image, GetAgentsResponse200DataItemImageType0):
        ...
        sub_agents: list[dict[str, Any]] | Unset = UNSET
        ...
        if sub_agents is not UNSET:
            field_dict["subAgents"] = sub_agents
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAgentsResponse200DataItemType(d.pop("type"))

        visibility = GetAgentsResponse200DataItemVisibility(d.pop("visibility"))

        status = GetAgentsResponse200DataItemStatus(d.pop("status"))
        ...
        def _parse_created_by_user(
            data: object,
        ) -> GetAgentsResponse200DataItemCreatedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_user_type_0 = (
                    GetAgentsResponse200DataItemCreatedByUserType0.from_dict(data)
                )

                return created_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetAgentsResponse200DataItemCreatedByUserType0 | None, data)
        ...
        def _parse_image(
            data: object,
        ) -> GetAgentsResponse200DataItemImageType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = GetAgentsResponse200DataItemImageType0.from_dict(data)

                return image_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetAgentsResponse200DataItemImageType0 | None | Unset, data)
        ...
        _sub_agents = d.pop("subAgents", UNSET)
        sub_agents: list[GetAgentsResponse200DataItemSubAgentsItem] | Unset = UNSET
        if _sub_agents is not UNSET:
            sub_agents = []
            for sub_agents_item_data in _sub_agents:
                sub_agents_item = GetAgentsResponse200DataItemSubAgentsItem.from_dict(
                    sub_agents_item_data
                )

                sub_agents.append(sub_agents_item)

        get_agents_response_200_data_item = cls(
            id=id,
            name=name,
            type_=type_,
            visibility=visibility,
        ...
        get_agents_response_200_data_item.additional_properties = d
        return get_agents_response_200_data_item
