...
from ..models.get_images_image_id_variants_response_200_data_item_scope import (
    GetImagesImageIdVariantsResponse200DataItemScope,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetImagesImageIdVariantsResponse200DataItem")


@_attrs_define
class GetImagesImageIdVariantsResponse200DataItem:
    """
    Attributes:
        id (str):
        name (str):
        scope (GetImagesImageIdVariantsResponse200DataItemScope):
        image_id (str):
        active_image_id (str):
        draft_image_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope = GetImagesImageIdVariantsResponse200DataItemScope(d.pop("scope"))
        ...
        get_images_image_id_variants_response_200_data_item = cls(
            id=id,
            name=name,
            scope=scope,
            image_id=image_id,
        ...
        get_images_image_id_variants_response_200_data_item.additional_properties = d
        return get_images_image_id_variants_response_200_data_item
