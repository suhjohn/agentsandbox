...
Coordinator case: add/update Modal secrets and attach them to an image's environment bindings.

```python
from agent_manager_client.generated_client.api.images import (
    get_images_image_id,
    get_images_image_id_environment_secrets,
    post_images_image_id_modal_secrets,
    put_images_image_id_environment_secrets,
)
from agent_manager_client.generated_client.models.post_images_image_id_modal_secrets_body import (
    PostImagesImageIdModalSecretsBody,
)
from agent_manager_client.generated_client.models.post_images_image_id_modal_secrets_body_env import (
    PostImagesImageIdModalSecretsBodyEnv,
)
from agent_manager_client.generated_client.models.put_images_image_id_environment_secrets_body import (
    PutImagesImageIdEnvironmentSecretsBody,
)

image_id = "<image-uuid>"
get_images_image_id.sync(image_id=image_id, client=manager_client)

env = PostImagesImageIdModalSecretsBodyEnv()
env["OPENAI_API_KEY"] = "sk-..."
env["ANTHROPIC_API_KEY"] = "sk-ant-..."

post_images_image_id_modal_secrets.sync(
    image_id=image_id,
    client=manager_client,
    body=PostImagesImageIdModalSecretsBody(
        name="image-runtime-secrets",
        env=env,
    ),
)

put_images_image_id_environment_secrets.sync(
    image_id=image_id,
    client=manager_client,
    body=PutImagesImageIdEnvironmentSecretsBody(
        modal_secret_name="image-runtime-secrets",
    ),
)

bindings = get_images_image_id_environment_secrets.sync(
    image_id=image_id,
    client=manager_client,
)
print(bindings)
