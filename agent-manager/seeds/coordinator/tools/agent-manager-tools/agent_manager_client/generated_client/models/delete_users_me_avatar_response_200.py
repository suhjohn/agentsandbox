...
if TYPE_CHECKING:
    from ..models.delete_users_me_avatar_response_200_workspace_keybindings_type_0 import (
        DeleteUsersMeAvatarResponse200WorkspaceKeybindingsType0,
    )


T = TypeVar("T", bound="DeleteUsersMeAvatarResponse200")


@_attrs_define
class DeleteUsersMeAvatarResponse200:
    """
    Attributes:
        id (str):
        email (str):
        ...
        workspace_keybindings (DeleteUsersMeAvatarResponse200WorkspaceKeybindingsType0 | None):
    """
    ...
    workspace_keybindings: (
        DeleteUsersMeAvatarResponse200WorkspaceKeybindingsType0 | None
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_workspace_keybindings(
            ...
            try:
                ...
                workspace_keybindings_type_0 = (
                    DeleteUsersMeAvatarResponse200WorkspaceKeybindingsType0.from_dict(
                        data
                    )
                )
                ...
                pass
            return cast(
                DeleteUsersMeAvatarResponse200WorkspaceKeybindingsType0 | None, data
            )
        ...
        delete_users_me_avatar_response_200 = cls(
            id=id,
            email=email,
            name=name,
            avatar=avatar,
        ...
        delete_users_me_avatar_response_200.additional_properties = d
        return delete_users_me_avatar_response_200
