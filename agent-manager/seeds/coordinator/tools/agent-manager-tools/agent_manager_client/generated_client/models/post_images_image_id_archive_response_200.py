...
from ..models.post_images_image_id_archive_response_200_visibility import (
    PostImagesImageIdArchiveResponse200Visibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostImagesImageIdArchiveResponse200")


@_attrs_define
class PostImagesImageIdArchiveResponse200:
    """
    Attributes:
        id (str):
        visibility (PostImagesImageIdArchiveResponse200Visibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = PostImagesImageIdArchiveResponse200Visibility(d.pop("visibility"))
        ...
        post_images_image_id_archive_response_200 = cls(
            id=id,
            visibility=visibility,
            name=name,
        ...
        post_images_image_id_archive_response_200.additional_properties = d
        return post_images_image_id_archive_response_200
