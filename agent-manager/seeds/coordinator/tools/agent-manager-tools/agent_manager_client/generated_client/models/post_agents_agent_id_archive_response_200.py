...
from ..models.post_agents_agent_id_archive_response_200_status import (
    PostAgentsAgentIdArchiveResponse200Status,
)
from ..models.post_agents_agent_id_archive_response_200_type import (
    PostAgentsAgentIdArchiveResponse200Type,
)
from ..models.post_agents_agent_id_archive_response_200_visibility import (
    PostAgentsAgentIdArchiveResponse200Visibility,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_agents_agent_id_archive_response_200_created_by_user_type_0 import (
        PostAgentsAgentIdArchiveResponse200CreatedByUserType0,
    )
    from ..models.post_agents_agent_id_archive_response_200_image_type_0 import (
        PostAgentsAgentIdArchiveResponse200ImageType0,
    )


T = TypeVar("T", bound="PostAgentsAgentIdArchiveResponse200")


@_attrs_define
class PostAgentsAgentIdArchiveResponse200:
    """
    Attributes:
        id (str):
        name (str):
        type_ (PostAgentsAgentIdArchiveResponse200Type):
        visibility (PostAgentsAgentIdArchiveResponse200Visibility):
        status (PostAgentsAgentIdArchiveResponse200Status):
        created_by (None | str):
        created_by_user (None | PostAgentsAgentIdArchiveResponse200CreatedByUserType0):
        ...
        image (None | PostAgentsAgentIdArchiveResponse200ImageType0 | Unset):
    ...
    image: None | PostAgentsAgentIdArchiveResponse200ImageType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.created_by_user, PostAgentsAgentIdArchiveResponse200CreatedByUserType0
        ):
        ...
        if isinstance(self.image, Unset):
            image = UNSET
        elif isinstance(self.image, PostAgentsAgentIdArchiveResponse200ImageType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PostAgentsAgentIdArchiveResponse200Type(d.pop("type"))

        visibility = PostAgentsAgentIdArchiveResponse200Visibility(d.pop("visibility"))

        status = PostAgentsAgentIdArchiveResponse200Status(d.pop("status"))
        ...
        def _parse_created_by_user(
            data: object,
        ) -> None | PostAgentsAgentIdArchiveResponse200CreatedByUserType0:
            if data is None:
                return data
            try:
                ...
                created_by_user_type_0 = (
                    PostAgentsAgentIdArchiveResponse200CreatedByUserType0.from_dict(
                        data
                    )
                )
                ...
                pass
            return cast(
                None | PostAgentsAgentIdArchiveResponse200CreatedByUserType0, data
            )
        ...
        def _parse_image(
            data: object,
        ) -> None | PostAgentsAgentIdArchiveResponse200ImageType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = PostAgentsAgentIdArchiveResponse200ImageType0.from_dict(
                    data
                )
                ...
                pass
            return cast(
                None | PostAgentsAgentIdArchiveResponse200ImageType0 | Unset, data
            )
        ...
        post_agents_agent_id_archive_response_200 = cls(
            id=id,
            name=name,
            type_=type_,
            visibility=visibility,
        ...
        post_agents_agent_id_archive_response_200.additional_properties = d
        return post_agents_agent_id_archive_response_200
