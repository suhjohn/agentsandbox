...
from ..models.get_images_image_id_response_200_visibility import (
    GetImagesImageIdResponse200Visibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetImagesImageIdResponse200")


@_attrs_define
class GetImagesImageIdResponse200:
    """
    Attributes:
        id (str):
        visibility (GetImagesImageIdResponse200Visibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = GetImagesImageIdResponse200Visibility(d.pop("visibility"))
        ...
        get_images_image_id_response_200 = cls(
            id=id,
            visibility=visibility,
            name=name,
        ...
        get_images_image_id_response_200.additional_properties = d
        return get_images_image_id_response_200
