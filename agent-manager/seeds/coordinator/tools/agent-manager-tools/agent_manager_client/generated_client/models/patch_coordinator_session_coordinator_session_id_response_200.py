...
T = TypeVar("T", bound="PatchCoordinatorSessionCoordinatorSessionIdResponse200")


@_attrs_define
class PatchCoordinatorSessionCoordinatorSessionIdResponse200:
    """
    Attributes:
        id (str):
        title (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_coordinator_session_coordinator_session_id_response_200 = cls(
            id=id,
            title=title,
        ...
        patch_coordinator_session_coordinator_session_id_response_200.additional_properties = d
        return patch_coordinator_session_coordinator_session_id_response_200
