...
from ..models.get_agents_agent_id_response_200_status import (
    GetAgentsAgentIdResponse200Status,
)
from ..models.get_agents_agent_id_response_200_type import (
    GetAgentsAgentIdResponse200Type,
)
from ..models.get_agents_agent_id_response_200_visibility import (
    GetAgentsAgentIdResponse200Visibility,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_agents_agent_id_response_200_created_by_user_type_0 import (
        GetAgentsAgentIdResponse200CreatedByUserType0,
    )
    from ..models.get_agents_agent_id_response_200_image_type_0 import (
        GetAgentsAgentIdResponse200ImageType0,
    )


T = TypeVar("T", bound="GetAgentsAgentIdResponse200")


@_attrs_define
class GetAgentsAgentIdResponse200:
    """
    Attributes:
        id (str):
        name (str):
        type_ (GetAgentsAgentIdResponse200Type):
        visibility (GetAgentsAgentIdResponse200Visibility):
        status (GetAgentsAgentIdResponse200Status):
        created_by (None | str):
        created_by_user (GetAgentsAgentIdResponse200CreatedByUserType0 | None):
        ...
        image (GetAgentsAgentIdResponse200ImageType0 | None | Unset):
    ...
    image: GetAgentsAgentIdResponse200ImageType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.created_by_user, GetAgentsAgentIdResponse200CreatedByUserType0
        ):
        ...
        if isinstance(self.image, Unset):
            image = UNSET
        elif isinstance(self.image, GetAgentsAgentIdResponse200ImageType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAgentsAgentIdResponse200Type(d.pop("type"))

        visibility = GetAgentsAgentIdResponse200Visibility(d.pop("visibility"))

        status = GetAgentsAgentIdResponse200Status(d.pop("status"))
        ...
        def _parse_created_by_user(
            data: object,
        ) -> GetAgentsAgentIdResponse200CreatedByUserType0 | None:
            if data is None:
                return data
            try:
                ...
                created_by_user_type_0 = (
                    GetAgentsAgentIdResponse200CreatedByUserType0.from_dict(data)
                )

                return created_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetAgentsAgentIdResponse200CreatedByUserType0 | None, data)
        ...
        def _parse_image(
            data: object,
        ) -> GetAgentsAgentIdResponse200ImageType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = GetAgentsAgentIdResponse200ImageType0.from_dict(data)

                return image_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetAgentsAgentIdResponse200ImageType0 | None | Unset, data)
        ...
        get_agents_agent_id_response_200 = cls(
            id=id,
            name=name,
            type_=type_,
            visibility=visibility,
        ...
        get_agents_agent_id_response_200.additional_properties = d
        return get_agents_agent_id_response_200
