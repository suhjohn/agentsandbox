...
from ..models.post_images_image_id_build_response_200_image_visibility import (
    PostImagesImageIdBuildResponse200ImageVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostImagesImageIdBuildResponse200Image")


@_attrs_define
class PostImagesImageIdBuildResponse200Image:
    """
    Attributes:
        id (str):
        visibility (PostImagesImageIdBuildResponse200ImageVisibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_images_image_id_build_response_200_image = cls(
            id=id,
            visibility=visibility,
            name=name,
        ...
        post_images_image_id_build_response_200_image.additional_properties = d
        return post_images_image_id_build_response_200_image
