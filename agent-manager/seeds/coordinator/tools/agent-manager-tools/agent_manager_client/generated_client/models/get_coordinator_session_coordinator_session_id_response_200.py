...
T = TypeVar("T", bound="GetCoordinatorSessionCoordinatorSessionIdResponse200")


@_attrs_define
class GetCoordinatorSessionCoordinatorSessionIdResponse200:
    """
    Attributes:
        id (str):
        title (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_coordinator_session_coordinator_session_id_response_200 = cls(
            id=id,
            title=title,
        ...
        get_coordinator_session_coordinator_session_id_response_200.additional_properties = d
        return get_coordinator_session_coordinator_session_id_response_200
