...
from ..models.post_images_image_id_unarchive_response_200_visibility import (
    PostImagesImageIdUnarchiveResponse200Visibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostImagesImageIdUnarchiveResponse200")


@_attrs_define
class PostImagesImageIdUnarchiveResponse200:
    """
    Attributes:
        id (str):
        visibility (PostImagesImageIdUnarchiveResponse200Visibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_images_image_id_unarchive_response_200 = cls(
            id=id,
            visibility=visibility,
            name=name,
        ...
        post_images_image_id_unarchive_response_200.additional_properties = d
        return post_images_image_id_unarchive_response_200
