...
T = TypeVar("T", bound="GetApiKeysResponse200DataItem")


@_attrs_define
class GetApiKeysResponse200DataItem:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_keys_response_200_data_item = cls(
            id=id,
            name=name,
        ...
        get_api_keys_response_200_data_item.additional_properties = d
        return get_api_keys_response_200_data_item
