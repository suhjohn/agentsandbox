...
from ..models.post_images_image_id_variants_response_201_scope import (
    PostImagesImageIdVariantsResponse201Scope,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostImagesImageIdVariantsResponse201")


@_attrs_define
class PostImagesImageIdVariantsResponse201:
    """
    Attributes:
        id (str):
        name (str):
        scope (PostImagesImageIdVariantsResponse201Scope):
        image_id (str):
        active_image_id (str):
        draft_image_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope = PostImagesImageIdVariantsResponse201Scope(d.pop("scope"))
        ...
        post_images_image_id_variants_response_201 = cls(
            id=id,
            name=name,
            scope=scope,
            image_id=image_id,
        ...
        post_images_image_id_variants_response_201.additional_properties = d
        return post_images_image_id_variants_response_201
