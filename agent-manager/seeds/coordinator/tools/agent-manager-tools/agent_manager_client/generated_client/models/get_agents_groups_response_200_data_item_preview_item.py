...
from ..models.get_agents_groups_response_200_data_item_preview_item_status import (
    GetAgentsGroupsResponse200DataItemPreviewItemStatus,
)
from ..models.get_agents_groups_response_200_data_item_preview_item_type import (
    GetAgentsGroupsResponse200DataItemPreviewItemType,
)
from ..models.get_agents_groups_response_200_data_item_preview_item_visibility import (
    GetAgentsGroupsResponse200DataItemPreviewItemVisibility,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_agents_groups_response_200_data_item_preview_item_created_by_user_type_0 import (
        GetAgentsGroupsResponse200DataItemPreviewItemCreatedByUserType0,
    )
    from ..models.get_agents_groups_response_200_data_item_preview_item_image_type_0 import (
        GetAgentsGroupsResponse200DataItemPreviewItemImageType0,
    )


T = TypeVar("T", bound="GetAgentsGroupsResponse200DataItemPreviewItem")


@_attrs_define
class GetAgentsGroupsResponse200DataItemPreviewItem:
    """
    Attributes:
        id (str):
        name (str):
        type_ (GetAgentsGroupsResponse200DataItemPreviewItemType):
        visibility (GetAgentsGroupsResponse200DataItemPreviewItemVisibility):
        status (GetAgentsGroupsResponse200DataItemPreviewItemStatus):
        created_by (None | str):
        created_by_user (GetAgentsGroupsResponse200DataItemPreviewItemCreatedByUserType0 | None):
        ...
        image (GetAgentsGroupsResponse200DataItemPreviewItemImageType0 | None | Unset):
    ...
    created_by: None | str
    created_by_user: (
        GetAgentsGroupsResponse200DataItemPreviewItemCreatedByUserType0 | None
    )
    created_at: datetime.datetime | str
    updated_at: datetime.datetime | str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.image, Unset):
            ...
            self.image, GetAgentsGroupsResponse200DataItemPreviewItemImageType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAgentsGroupsResponse200DataItemPreviewItemType(d.pop("type"))

        visibility = GetAgentsGroupsResponse200DataItemPreviewItemVisibility(
            d.pop("visibility")
        )

        status = GetAgentsGroupsResponse200DataItemPreviewItemStatus(d.pop("status"))
        ...
        def _parse_created_by_user(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_user_type_0 = GetAgentsGroupsResponse200DataItemPreviewItemCreatedByUserType0.from_dict(
                    data
                )
        ...
        def _parse_image(
            data: object,
        ) -> GetAgentsGroupsResponse200DataItemPreviewItemImageType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = (
                    GetAgentsGroupsResponse200DataItemPreviewItemImageType0.from_dict(
                        data
                    )
                )
        ...
        get_agents_groups_response_200_data_item_preview_item = cls(
            id=id,
            name=name,
            type_=type_,
            visibility=visibility,
        ...
        get_agents_groups_response_200_data_item_preview_item.additional_properties = d
        return get_agents_groups_response_200_data_item_preview_item
