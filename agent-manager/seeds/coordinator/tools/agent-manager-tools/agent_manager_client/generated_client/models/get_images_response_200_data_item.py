...
from ..models.get_images_response_200_data_item_visibility import (
    GetImagesResponse200DataItemVisibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetImagesResponse200DataItem")


@_attrs_define
class GetImagesResponse200DataItem:
    """
    Attributes:
        id (str):
        visibility (GetImagesResponse200DataItemVisibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = GetImagesResponse200DataItemVisibility(d.pop("visibility"))
        ...
        get_images_response_200_data_item = cls(
            id=id,
            visibility=visibility,
            name=name,
        ...
        get_images_response_200_data_item.additional_properties = d
        return get_images_response_200_data_item
