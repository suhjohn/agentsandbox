...
from ..models.patch_images_image_id_response_200_visibility import (
    PatchImagesImageIdResponse200Visibility,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchImagesImageIdResponse200")


@_attrs_define
class PatchImagesImageIdResponse200:
    """
    Attributes:
        id (str):
        visibility (PatchImagesImageIdResponse200Visibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = PatchImagesImageIdResponse200Visibility(d.pop("visibility"))
        ...
        patch_images_image_id_response_200 = cls(
            id=id,
            visibility=visibility,
            name=name,
        ...
        patch_images_image_id_response_200.additional_properties = d
        return patch_images_image_id_response_200
