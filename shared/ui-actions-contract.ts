...
export const UI_ACTIONS = defineUiActionDescriptors([
  ...
  { id: "coordinator.dialog.select_session", version: 1, title: "Select Coordinator Session", description: "Select a coordinator session in dialog conversation view.", category: "parameterized", surfaces: { keyboard: false, palette: false, coordinator: true }, paramsJsonSchema: { type: "object", additionalProperties: false, required: ["coordinatorSessionId"], properties: { coordinatorSessionId: { type: "string", minLength: 1 } } } },
