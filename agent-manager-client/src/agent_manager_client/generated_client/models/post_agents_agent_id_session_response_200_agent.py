...
from ..models.post_agents_agent_id_session_response_200_agent_status import (
    PostAgentsAgentIdSessionResponse200AgentStatus,
)
from ..models.post_agents_agent_id_session_response_200_agent_type import (
    PostAgentsAgentIdSessionResponse200AgentType,
)
from ..models.post_agents_agent_id_session_response_200_agent_visibility import (
    PostAgentsAgentIdSessionResponse200AgentVisibility,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_agents_agent_id_session_response_200_agent_created_by_user_type_0 import (
        PostAgentsAgentIdSessionResponse200AgentCreatedByUserType0,
    )
    from ..models.post_agents_agent_id_session_response_200_agent_image_type_0 import (
        PostAgentsAgentIdSessionResponse200AgentImageType0,
    )


T = TypeVar("T", bound="PostAgentsAgentIdSessionResponse200Agent")


@_attrs_define
class PostAgentsAgentIdSessionResponse200Agent:
    """
    Attributes:
        id (str):
        name (str):
        type_ (PostAgentsAgentIdSessionResponse200AgentType):
        visibility (PostAgentsAgentIdSessionResponse200AgentVisibility):
        status (PostAgentsAgentIdSessionResponse200AgentStatus):
        created_by (None | str):
        created_by_user (None | PostAgentsAgentIdSessionResponse200AgentCreatedByUserType0):
        ...
        image (None | PostAgentsAgentIdSessionResponse200AgentImageType0 | Unset):
    ...
    image: None | PostAgentsAgentIdSessionResponse200AgentImageType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.image, Unset):
            image = UNSET
        elif isinstance(self.image, PostAgentsAgentIdSessionResponse200AgentImageType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PostAgentsAgentIdSessionResponse200AgentType(d.pop("type"))

        visibility = PostAgentsAgentIdSessionResponse200AgentVisibility(
            d.pop("visibility")
        )

        status = PostAgentsAgentIdSessionResponse200AgentStatus(d.pop("status"))
        ...
        def _parse_created_by_user(
            data: object,
        ) -> None | PostAgentsAgentIdSessionResponse200AgentCreatedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_user_type_0 = PostAgentsAgentIdSessionResponse200AgentCreatedByUserType0.from_dict(
                    data
                )
                ...
                pass
            return cast(
                None | PostAgentsAgentIdSessionResponse200AgentCreatedByUserType0, data
            )
        ...
        def _parse_image(
            data: object,
        ) -> None | PostAgentsAgentIdSessionResponse200AgentImageType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = (
                    PostAgentsAgentIdSessionResponse200AgentImageType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PostAgentsAgentIdSessionResponse200AgentImageType0 | Unset, data
            )
        ...
        post_agents_agent_id_session_response_200_agent = cls(
            id=id,
            name=name,
            type_=type_,
            visibility=visibility,
        ...
        post_agents_agent_id_session_response_200_agent.additional_properties = d
        return post_agents_agent_id_session_response_200_agent
