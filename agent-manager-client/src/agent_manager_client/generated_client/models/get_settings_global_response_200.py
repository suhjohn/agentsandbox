...
T = TypeVar("T", bound="GetSettingsGlobalResponse200")


@_attrs_define
class GetSettingsGlobalResponse200:
    """
    Attributes:
        diffignore (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_settings_global_response_200 = cls(
            diffignore=diffignore,
            default_coordinator_image_id=default_coordinator_image_id,
        )

        get_settings_global_response_200.additional_properties = d
        return get_settings_global_response_200
