...
T = TypeVar("T", bound="GetImagesImageIdEnvironmentSecretsResponse200DataItem")


@_attrs_define
class GetImagesImageIdEnvironmentSecretsResponse200DataItem:
    """
    Attributes:
        id (str):
        image_id (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_images_image_id_environment_secrets_response_200_data_item = cls(
            id=id,
            image_id=image_id,
        ...
        get_images_image_id_environment_secrets_response_200_data_item.additional_properties = d
        return get_images_image_id_environment_secrets_response_200_data_item
