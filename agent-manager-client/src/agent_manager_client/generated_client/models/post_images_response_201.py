...
from ..models.post_images_response_201_visibility import PostImagesResponse201Visibility
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostImagesResponse201")


@_attrs_define
class PostImagesResponse201:
    """
    Attributes:
        id (str):
        visibility (PostImagesResponse201Visibility):
        name (str):
        created_by (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = PostImagesResponse201Visibility(d.pop("visibility"))
        ...
        post_images_response_201.additional_properties = d
        return post_images_response_201
