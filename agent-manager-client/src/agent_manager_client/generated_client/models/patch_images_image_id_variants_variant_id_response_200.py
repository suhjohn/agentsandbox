...
from ..models.patch_images_image_id_variants_variant_id_response_200_scope import (
    PatchImagesImageIdVariantsVariantIdResponse200Scope,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchImagesImageIdVariantsVariantIdResponse200")


@_attrs_define
class PatchImagesImageIdVariantsVariantIdResponse200:
    """
    Attributes:
        id (str):
        name (str):
        scope (PatchImagesImageIdVariantsVariantIdResponse200Scope):
        image_id (str):
        active_image_id (str):
        draft_image_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope = PatchImagesImageIdVariantsVariantIdResponse200Scope(d.pop("scope"))
        ...
        patch_images_image_id_variants_variant_id_response_200 = cls(
            id=id,
            name=name,
            scope=scope,
            image_id=image_id,
        ...
        patch_images_image_id_variants_variant_id_response_200.additional_properties = d
        return patch_images_image_id_variants_variant_id_response_200
