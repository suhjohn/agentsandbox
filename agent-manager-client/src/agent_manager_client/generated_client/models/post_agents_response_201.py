...
from ..models.post_agents_response_201_status import PostAgentsResponse201Status
from ..models.post_agents_response_201_type import PostAgentsResponse201Type
from ..models.post_agents_response_201_visibility import PostAgentsResponse201Visibility
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_agents_response_201_created_by_user_type_0 import (
        PostAgentsResponse201CreatedByUserType0,
    )
    from ..models.post_agents_response_201_image_type_0 import (
        PostAgentsResponse201ImageType0,
    )


T = TypeVar("T", bound="PostAgentsResponse201")


@_attrs_define
class PostAgentsResponse201:
    """
    Attributes:
        id (str):
        name (str):
        type_ (PostAgentsResponse201Type):
        visibility (PostAgentsResponse201Visibility):
        status (PostAgentsResponse201Status):
        created_by (None | str):
        created_by_user (None | PostAgentsResponse201CreatedByUserType0):
        ...
        image (None | PostAgentsResponse201ImageType0 | Unset):
    ...
    image: None | PostAgentsResponse201ImageType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.created_by_user, PostAgentsResponse201CreatedByUserType0):
        ...
        if isinstance(self.image, Unset):
            image = UNSET
        elif isinstance(self.image, PostAgentsResponse201ImageType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PostAgentsResponse201Type(d.pop("type"))

        visibility = PostAgentsResponse201Visibility(d.pop("visibility"))

        status = PostAgentsResponse201Status(d.pop("status"))
        ...
        def _parse_created_by_user(
            data: object,
        ) -> None | PostAgentsResponse201CreatedByUserType0:
            if data is None:
                return data
            try:
                ...
                created_by_user_type_0 = (
                    PostAgentsResponse201CreatedByUserType0.from_dict(data)
                )

                return created_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostAgentsResponse201CreatedByUserType0, data)
        ...
        def _parse_image(
            data: object,
        ) -> None | PostAgentsResponse201ImageType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = PostAgentsResponse201ImageType0.from_dict(data)

                return image_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostAgentsResponse201ImageType0 | Unset, data)
        ...
        post_agents_response_201.additional_properties = d
        return post_agents_response_201
